...
audited-content-sha256: f308e8521c4c10ac54142a42f5abdeb90b1b3598428136b0f7c9b540c2aa77cc (re-pinned 2026-08-07 for RFC-6: the governed files moved from the v2 clause surface (`req`/`ens`/`fx`/`inv`/`dec`) to full words with the effect row on the arrow (`requires`/`ensures`/`!`/`keeps`/`measures`). Prose in this document was migrated in the same commit, so the pin covers a re-read rather than a bump. prior: 6782fa1058396008cca3828433793cdf7e66ea3bf8521ba378d965537aca4a38, previously (re-pinned 2026-08-01 after auditing the bootable multicore kernel integration; existing behavior remains regression-covered))
governs:
