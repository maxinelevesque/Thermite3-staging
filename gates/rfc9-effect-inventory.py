...
RUST_REVIEW = {
    ...
    "thermite-lower/src/relational_frame_witness.rs": "Tier-A relational-frame canonical witness fixtures with RFC-9 region effect atoms",
    ...
    "thermite-lower/tests/interference_fail_closed.rs": "RFC-12 release-boundary fixtures with RFC-9 region effect atoms",
    "thermite-lower/tests/interference_witness.rs": "RFC-12 relational-witness fixtures with RFC-9 region effect atoms",
    "thermite-lower/tests/relational_frame_witness.rs": "Tier-A relational-frame replay fixtures with RFC-9 region effect atoms",
    ...
    "thermite-spec/tests/interference_fail_closed.rs": "RFC-12 fail-closed fixtures with RFC-9 region effect atoms",
    "thermite-spec/tests/interference_validate.rs": "RFC-12 relation-validation fixtures with RFC-9 region effect atoms",
    ...
    "thermite-syntax/tests/interference_clauses.rs": "RFC-12 parser fixtures with RFC-9 region effect atoms",
