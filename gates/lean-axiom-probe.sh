...
THEOREMS=(
  ...
  "Thermite.RelationalFrame.Expr.eval_congruent"
  "Thermite.RelationalFrame.Program.run_frames_writes"
  "Thermite.RelationalFrame.Program.run_result_congruent"
  "Thermite.RelationalFrame.Program.relational_frame"
  "Thermite.RelationalFrame.Program.outside_write_equal"
  "Thermite.RelationalFrame.Bounded.Expr.eval_congruent"
  "Thermite.RelationalFrame.Bounded.Program.run_frames_writes"
  "Thermite.RelationalFrame.Bounded.Program.run_result_congruent"
  "Thermite.RelationalFrame.Bounded.Program.relational_frame"
  "Thermite.RelationalFrame.Bounded.Examples.setA_relational_frame"
  "Thermite.RelationalFrame.allPrimitiveEffects_complete"
  "Thermite.RelationalFrame.allPrimitiveEffects_nodup"
  "Thermite.RelationalFrame.allEffectKinds_complete"
  "Thermite.RelationalFrame.allEffectKinds_nodup"
  "Thermite.RelationalFrame.net_retains_write_frame"
  "Thermite.RelationalFrame.net_is_state_plus_io"
  "Thermite.RelationalFrame.accrues_has_accumulator_agreement"
  "Thermite.RelationalFrame.io_requires_external_coupling_but_retains_frame"
  "Thermite.RelationalFrame.exception_retains_outcome_and_frame"
  "Thermite.RelationalFrame.partiality_separates_completed_pairs_from_termination"
  "Thermite.RelationalFrame.bare_random_requires_new_denotation"
  "Thermite.RelationalFrame.blocks_requires_peer_progress"
  "Thermite.RelationalFrameWitness.producerRefines_iff"
  "Thermite.RelationalFrameWitness.verify_iff_supported"
  "Thermite.RelationalFrameWitness.produce_complete"
  "Thermite.RelationalFrameWitness.Examples.accepted"
  ...
  "Thermite.CertificationMetatheory.policy_v1_to_v2_preserves_incomparable_frontier"
  "Thermite.CertificationMetatheory.policy_v1_to_v2_preserves_intersection"
  "Thermite.CertificationMetatheory.generated_policy_migration_replay_matches_checked_relation"
  "Thermite.CertificationMetatheory.forged_receipt_accepted_mutant_is_rejected"
  ...
  "Thermite.CertificationMetatheory.engineer_meaning_is_licensed"
  "Thermite.CertificationMetatheory.admitted_population_is_nonempty"
  "Thermite.CertificationMetatheory.one_execution_membership_has_exact_identity"
  "Thermite.CertificationMetatheory.bounded_membership_respects_exact_bound"
  "Thermite.CertificationMetatheory.admitted_order_is_semantically_sound"
  "Thermite.CertificationMetatheory.engineer_projection_fiber_is_exact"
  "Thermite.CertificationMetatheory.named_boundary_cannot_be_nominal_true"
  "Thermite.CertificationMetatheory.admitted_fragment_cannot_be_nominal_true"
  "Thermite.CertificationMetatheory.intersectNF_denotation"
  "Thermite.CertificationMetatheory.frontier_covers_support"
  "Thermite.CertificationMetatheory.frontier_members_are_maximal"
  "Thermite.CertificationMetatheory.frontier_members_are_pairwise_incomparable"
  "Thermite.CertificationMetatheory.support_iff_below_frontier"
  "Thermite.CertificationMetatheory.antichain_nf_is_extensional"
  "Thermite.CertificationMetatheory.intersectAllNF_empty_is_explicit_no_items"
  "Thermite.CertificationMetatheory.intersectNonemptyNF_denotation"
  "Thermite.CertificationMetatheory.intersectNonemptyNF_permutation_invariant"
  "Thermite.CertificationMetatheory.intersectNonemptyNF_head_swap_invariant"
  "Thermite.CertificationMetatheory.lower_bound_frontier_is_sound"
  "Thermite.CertificationMetatheory.lower_bound_frontier_is_complete"
  "Thermite.CertificationMetatheory.arbitrary_bounds_are_exact_not_sampled"
  "Thermite.CertificationMetatheory.generated_replay_matches_symbolic_policy"
  "Thermite.CertificationMetatheory.omitted_family_mutant_is_rejected"
  "Thermite.CertificationMetatheory.predecessor_representative_image_is_exact"
  "Thermite.CertificationMetatheory.predecessor_policy_image_is_exact"
  "Thermite.CertificationMetatheory.predecessor_carriers_omit_new_v2_families"
  "Thermite.CertificationMetatheory.predecessor_runtime_bounded_edge_crosses_v2_population"
  "Thermite.CertificationMetatheory.predecessor_bounded_solver_edge_crosses_v2_population"
  "Thermite.CertificationMetatheory.predecessor_bounded_empirical_edge_crosses_v2_population"
  "Thermite.CertificationMetatheory.predecessor_disposition_is_exact"
  "Thermite.CertificationMetatheory.predecessor_disposition_matrix_covers_all_sixteen_pairs"
  "Thermite.CertificationMetatheory.ProjectPopulation.member_identities_are_nodup"
  "Thermite.CertificationMetatheory.PortfolioLift.certifiesItem"
  "Thermite.CertificationMetatheory.intersectClaimSets_denotation"
  "Thermite.CertificationMetatheory.intersectClaimSets_permutation_invariant"
  "Thermite.CertificationMetatheory.intersectClaimSets_duplicate_invariant"
  "Thermite.CertificationMetatheory.unavailable_clause_makes_item_claim_set_empty"
  "Thermite.CertificationMetatheory.explicit_absent_transport_makes_common_empty"
  "Thermite.CertificationMetatheory.ProjectPopulation.portraitScope_is_never_whole"
  "Thermite.CertificationMetatheory.ProjectLift.certifiesProject"
  "Thermite.CertificationMetatheory.ProjectLift.authorizes_whole_project"
  "Thermite.CertificationMetatheory.ProjectLift.every_item_transport_present"
  "Thermite.CertificationMetatheory.ProjectLift.falseConjunctRefutes"
  "Thermite.CertificationMetatheory.ProjectRefutationCompleteness.complete"
  "Thermite.CertificationMetatheory.mixed_incomparable_common_frontier_is_not_a_representative"
  "Thermite.CertificationMetatheory.mixed_incomparable_evidence_frontier_retains_provenance"
  "Thermite.CertificationMetatheory.mixed_portfolio_lift_certifies_item"
  "Thermite.CertificationMetatheory.mixed_portfolio_claim_set_is_exact_intersection"
  "Thermite.CertificationMetatheory.dropped_clause_cannot_satisfy_complete_portfolio"
  "Thermite.CertificationMetatheory.multi_item_project_lift_transports_every_item"
  "Thermite.CertificationMetatheory.one_false_conjunct_soundly_refutes_project"
  "Thermite.CertificationMetatheory.WorkspacePopulation.member_identities_are_nodup"
  "Thermite.CertificationMetatheory.canonical_workspace_coordinates_permutation_invariant"
  "Thermite.CertificationMetatheory.canonical_workspace_coordinates_duplicate_invariant"
  "Thermite.CertificationMetatheory.project_conjunction_permutation_invariant"
  "Thermite.CertificationMetatheory.project_conjunction_duplicate_invariant"
  "Thermite.CertificationMetatheory.WorkspacePopulation.portraitScope_is_never_whole"
  "Thermite.CertificationMetatheory.WorkspaceLift.certifiesWorkspace"
  "Thermite.CertificationMetatheory.WorkspaceLift.authorizes_whole_workspace"
  "Thermite.CertificationMetatheory.generated_workspace_replay_matches_checked_composition"
  "Thermite.CertificationMetatheory.omitted_item_accepted_mutant_is_rejected"
