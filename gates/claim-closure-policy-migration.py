#!/usr/bin/env python3
"""Discriminate the checked assurance policy-migration claims."""
...
VERSION = "thermite-claim-closure-policy-migration 1"
PROBE = "assurance-policy-migration"
CASE_TIMEOUT_SECONDS = 360
ROOT = Path(__file__).resolve().parents[1]


CASES = {
    "policy-migration-rust": [
        "cargo",
        "test",
        "--quiet",
        "--locked",
    ...
    "policy-migration-level-boundary": [
        sys.executable,
        "-m",
        "unittest",
        "gates.tests.test_assurance_policy_migration_replay.AssurancePolicyMigrationReplayTest.test_policy_migration_never_reads_archival_levels",
    ],
}
