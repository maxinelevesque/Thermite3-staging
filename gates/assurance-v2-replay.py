...
def validate(root: Path, data: object) -> list[str]:
    ...
    for source, needles in {
        ...
        "lean/Thermite/AssuranceComposition.lean": [
            "ProjectPopulation",
            "PortfolioLift",
            "ItemClaimSet",
            "commonClaimFrontier",
            "evidenceFrontier",
            "ProjectLift",
            "intersectClaimSets_permutation_invariant",
            "explicit_absent_transport_makes_common_empty",
            "portraitScope_is_never_whole",
        ],
