...
CASES = {
    ...
    "spec-validator-ergonomics-guard": integration("claim_closure_wave18", "validator_guarded_arms_do_not_close_matches_but_guards_are_walked"),
    "spec-validator-ergonomics-or-pattern": integration("claim_closure_wave18", "validator_or_patterns_union_variants_and_propagate_catchalls"),
    "spec-validator-flat-closure": integration("claim_closure_wave18", "validator_combinator_closures_are_flat_but_named_spec_calls_survive"),
    "spec-validator-map-cage": integration("claim_closure_wave18", "validator_map_contract_methods_are_caged_and_mutators_are_absent"),
    "spec-validator-recursion-decreases": integration("claim_closure_wave18", "validator_direct_recursion_requires_decreases_unless_diverge"),
    "spec-validator-reject": integration("claim_closure_wave18", "validator_rejections_are_structured_and_depth_bounded"),
    "spec-validator-scheme-cage": integration("claim_closure_wave18", "validator_scheme_cage_separates_top_level_and_nested_calls"),
    "spec-validator-scheme-errors": integration("claim_closure_wave18", "validator_scheme_errors_are_explicit_and_total"),
    "spec-validator-scheme-flat-step": integration("claim_closure_wave18", "validator_scheme_step_checks_closure_arity_and_flat_body"),
    "spec-validator-scheme-recognition": integration("claim_closure_wave18", "validator_resolves_registered_schemes_before_combinators"),
    "spec-validator-sealed-construction": integration("claim_closure_wave18", "validator_sealed_struct_literals_cannot_mint_capabilities"),
    "syntax-effect-basis": integration("claim_closure_wave18", "syntax_effect_basis_generates_primitive_frames_and_keeps_given_atoms_distinct"),
    "syntax-effect-declared": integration("claim_closure_wave18", "syntax_effect_declarations_resolve_only_to_the_fixed_basis"),
    "syntax-effect-footprint": integration("claim_closure_wave18", "syntax_effect_footprints_derive_reads_and_writes_from_operations"),
    "syntax-effect-route": integration("claim_closure_wave18", "syntax_effect_routes_expose_implemented_deferred_and_open_trust"),
    "syntax-holding-block": integration("claim_closure_wave18", "syntax_holding_block_is_lexical_while_owns_is_declared"),
    "syntax-lock-decl": integration("claim_closure_wave18", "syntax_lock_declarations_name_guarded_regions_and_order"),
    "syntax-shared-decl": integration("claim_closure_wave18", "syntax_shared_declarations_anchor_effect_region_paths"),
    "tv-body-state-denotation": integration("claim_closure_wave18", "tv_body_reference_threads_state_and_projects_tuple_cells"),
    "tv-body-stmt-subset": integration("claim_closure_wave18", "tv_body_reference_loudly_rejects_out_of_v1_statements"),
    "tv-contract-forge-plugin": integration("claim_closure_wave18", "tv_contract_forge_plugin_joins_production_and_reference_paths"),
    "tv-contract-generator": integration("claim_closure_wave18", "tv_contract_generator_is_deterministic_typed_and_bounded"),
    "tv-contract-obligation": integration("claim_closure_wave18", "tv_contract_obligation_compares_production_and_reference_equivalence"),
    "tv-contract-ref-encoder": integration("claim_closure_wave18", "tv_contract_reference_encoder_is_independent_and_total"),
    "tv-contract-teeth": integration("claim_closure_wave18", "tv_contract_teeth_verify_faithful_and_catch_infidel_clauses"),
