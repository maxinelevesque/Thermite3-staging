...
{
  "v": 2,
  "cid": "bafyreiatip42fmzy7cmbm4lk3xbc5guv7r5hpjk55vhjt44w67jydengfi",
  "sig": "fc5065f2f937016bce0710aa3f416255fbd92e04ee8b88d57e7b0379fccbac9c3406b8b2ab781c64eda967d2b5e92892225a33eab1f9cbb0f22a072f4877a722",
  "author": "did:key:zDnaekvyhdCRM1T1yw1BQgsoyEvmoyW27an3a8rygZPqbge2V",
  "subject": "Local(\"bridge/land-the-anchor\")",
  "kind": "Result",
  "cites": [],
  ...
  "of": 9,
  "text_len": 507,
  "content": ""
}
---

PR 11 squashed to one commit and force-pushed. 936e07e9 plus b10edfa8 (the orphaned comment and reformat) plus 22fda741 (four design-doc re-pins) became c563bda3, parent 84d276e7 so the branch stays cut from an upstream ref. Verified before moving the ref: tree e20f20e8 both sides, git diff empty. The message is 936e07e9 rebuilt programmatically rather than retyped, with one paragraph inserted before Closes #10 covering the comment and the re-pins. Nothing orphaned - 0 reviews and 0 comments on the PR.
---8<---
---
{
  "v": 2,
  "cid": "bafyreignb2in4cdsi47jc4yrpaa5a7ygrnieik2tgy3e4u3dy6wibs62mu",
  "sig": "fe4532f8f1238c1a11995572f9632cf77f9019d0c49c7c8b5a92a214cb007f7935ecbefec08c4f79ff3ab4146c8544097e669a5f9e35b8fae9f24f1f6568fdb9",
  "author": "did:key:zDnaekvyhdCRM1T1yw1BQgsoyEvmoyW27an3a8rygZPqbge2V",
  "subject": "Local(\"bridge/land-the-anchor\")",
  "kind": "Result",
  "cites": [
    "bafyreiatip42fmzy7cmbm4lk3xbc5guv7r5hpjk55vhjt44w67jydengfi"
  ],
  "rev": "223msjefvm7lg",
  "seq": 8,
  "of": 9,
  "text_len": 808,
  "content": ""
}
---

PR 11 is fully green in CI at c563bda3 - 12 of 12 checks, and the checks job all 18 steps. This is the first time the four late gates have EVER run on that branch, because cargo fmt failed first on every prior attempt: cargo clippy --workspace --all-targets -D warnings, the bv build-flag gate, cargo test --doc, and the skill budget gate. Verified they did real work rather than trusting the aggregate, since the job finished in 1m6s on a warm cache: clippy reports Checking across the workspace and Finished in 13.51s, and the skill gate compiled and printed skill token count 5478 (budget 6000). So the earlier claim of zero regressions on the kernel removal is now CI-established rather than local, and the correction recorded earlier - that those gates were unmeasured rather than green - is discharged.
